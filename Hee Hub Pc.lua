...
local pop = serv:Channel("Auto Farm")
pop:Toggle("AutoFarm",false,function(Farm)
    getgenv().AutoFarm = Farm
end)
pop:Toggle("Auto Superhuman",false, function(Superhuman)
    Superhuman = Superhuman
end)

pop:Toggle("Auto-SetSpawn", false, function(SetSpawn)
    AutoSetSpawn = SetSpawn
end)

local SelectToolWeapona = pop:Dropdown("SelectWeapon",Weapon,function(Select)
    SelectWeapon = Select
end)

pop:Button("Refresh Weapon", function()
...
pop:Button("Redeem All Code", function()
                ...
                if getgenv().AutoFarm then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        for i2,v2 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do	
                            if v.Name == Mon and (v.HumanoidRootPart.Position - v2.HumanoidRootPart.Position).magnitude <= 300 then
                                if v2.Name == Mon and (v.HumanoidRootPart.Position - v2.HumanoidRootPart.Position).magnitude <= 300 then
                        ...
                        for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                            if v.Name == Mon and v.Humanoid.Health > 0 then
                                repeat wait()
                                    ...
                                    v.HumanoidRootPart.Size = Vector3.new(100,100,100)
                                    v.HumanoidRootPart.CanCollide = false
                                    TP2(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
